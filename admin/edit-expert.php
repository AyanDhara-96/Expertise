					...
					<div class="col-xl-12 mx-auto">
						<div class="card">
							...
							<div class="card-body p-4">
								<form class="row g-3 needs-validation" method="post" enctype="multipart/form-data" action="update-expert.php?id=<?php echo$id?>">
                                <input type="num" class="form-control" hidden value="<?php echo $data['id']; ?>" name="id" >
                                <input type="hidden" name="type" value="expert">
									...
									<div class="col-md-6">
										...
										<textarea class="form-control" name="address" placeholder="Product Address ..." rows="3" required="" value="<?php echo $data['address']; ?>"></textarea>
									</div>
									<?php
									...
									<div class="col-md-3">
										...
										<input type="text" class="form-control" name="zipcode" value="<?php echo $data['zipcode']; ?>"required>
									</div>
									<div class="col-md-3">
									...
									<div class="col-md-3">
										...
										<input type="text" class="form-control" name="phnumber" placeholder="Enter Phone Number"value="<?php echo $data['phone']; ?>" required>
									</div>
									<div class="col-md-3">
										<label class="form-label">Expert Image</label>
										<input type="file" class="form-control" name="photo" value="<?php echo $data['photo']; ?>"required>
									</div>
									<div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
										...
										<input type="text" class="form-control" name="password" placeholder="Enter Password" value="<?php echo $data['password'];?>" required>
									</div>
